 ...
 */
final class Version20260625090658 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE term (id BINARY(16) NOT NULL, name VARCHAR(255) NOT NULL, vocabulary VARCHAR(32) NOT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX uniq_term_name_vocabulary (name, vocabulary), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE `user` (id BINARY(16) NOT NULL, email VARCHAR(180) NOT NULL, name VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
