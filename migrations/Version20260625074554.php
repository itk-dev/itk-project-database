 ...
 */
final class Version20260625074554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE initiative_contact (initiative_id INT NOT NULL, contact_id INT NOT NULL, INDEX IDX_6F980462AB7D9771 (initiative_id), INDEX IDX_6F980462E7A1254A (contact_id), PRIMARY KEY (initiative_id, contact_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE initiative_stakeholder (initiative_id INT NOT NULL, term_id INT NOT NULL, INDEX IDX_C97AB0E7AB7D9771 (initiative_id), INDEX IDX_C97AB0E7E2C35FC (term_id), PRIMARY KEY (initiative_id, term_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE initiative_tag (initiative_id INT NOT NULL, term_id INT NOT NULL, INDEX IDX_4FF4E32DAB7D9771 (initiative_id), INDEX IDX_4FF4E32DE2C35FC (term_id), PRIMARY KEY (initiative_id, term_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE term (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, vocabulary VARCHAR(32) NOT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX uniq_term_name_vocabulary (name, vocabulary), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, name VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
